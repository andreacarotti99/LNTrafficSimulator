...
def simulate_incrementally_removing_high_degree_nodes(hdn_to_remove, directed_edges, providers, amount, count, drop_disabled, drop_low_cap, with_depletion, find_alternative_paths):
    ...
    simulator = ts_topologies.TransactionSimulatorDifferentTopologies(directed_edges,
                                                                      providers, amount, count,
    ...
    shortest_paths_list, alternative_paths_list, all_router_fees_list, total_depletions_list,\
        successful_transactions, FinalGraph, avg_degree_list, routed_transactions_list = \
    ...
    return FinalGraph, all_router_fees_list, shortest_paths_list, avg_degree_list, routed_transactions_list
