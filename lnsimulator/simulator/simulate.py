...
def simulate_incrementally_removing_high_degree_nodes(hdn_to_split, hdn_to_remove, directed_edges, providers, amount, count, drop_disabled, drop_low_cap, with_depletion, find_alternative_paths):
